    ...
    return ControllerExtension.extend("zsbu4repmr903.ext.controller.ListReport", {
      ...
      _createValueHelpDialog: async function (oView) {
        ...
        this._oPPVHD.getTableAsync().then((oTable) => {
          ...
          if (oTable.setMode) oTable.setMode("SingleSelectMaster");
          if (oTable.setIncludeItemInSelection) oTable.setIncludeItemInSelection(true);
          if (oTable.setSelectionBehavior && sap.ui.table && sap.ui.table.SelectionBehavior) {
